...
**Date:** March 2026
**Version:** 5.0
**Target:** Science & Technology PWG, Economy PWG, Policy Development Committee
...
economics) in the companion document `revenue_model.md`.
...
| Document | Contents |
|---|---|
| `revenue_model.md` | SEBE revenue derivation from first principles |
| `cost_model.md` | Revenue in context, scale comparison |
| `distribution_model.md` | Two-stage UBI to ULI illustrative model |
| `academic_brief.md` | Full technical paper (orthodox framing) |
| `academic_brief_mmt.md` | Full technical paper (MMT framing) |
