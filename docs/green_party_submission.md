...
**Date:** March 2026
**Version:** 5.0
**Target:** Science & Technology PWG, Economy PWG, Energy PWG, Policy Development Committee
...
`revenue_model.md` Section 8.3 for scenario analysis.
...
| `automation_risk.md` | Six automation waves, asymmetric risk analysis (MMT framing) |
| `automation_risk_orthodox.md` | Orthodox variant: revenue and tax base framing |
