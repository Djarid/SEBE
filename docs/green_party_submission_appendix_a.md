...
## Technical Feasibility of the Sovereign Energy Excise and Digital Customs Duty

**Author:** Jason Huxley
**Date:** March 2026
**Version:** 1.0
**Target:** Science & Technology PWG, Energy PWG, Policy Development Committee
**Parent document:** `green_party_submission.md` (v5.0)
...
at 85% utilisation, PUE 1.3). Full derivation in `revenue_model.md`
Section 4.
