...
| Mechanism | 2030 Revenue | Scales with automation? |
|---|---|---|
| SEBE (SEE + DCD) | £34-46 billion | Yes (energy + bandwidth grow with automation) |
| Consumption tax on AI services | Unknown | Only if consumers can afford to buy them |
| Windfall clauses | £0 (voluntary) | No |
| Sovereign wealth fund | Requires a revenue source | Depends on capitalisation |
...
*Jason Huxley is an infrastructure and automation engineer (ex-Royal Corps of Signals) with 30 years' experience in large-scale enterprise systems. He is a member of the Green Party of England and Wales. His previous posts: [Tax Robots, Fund People](https://medium.com/@djarid997/tax-robots-fund-people-1320f5121e58) and [Why I Joined the Green Party and Built a Tax Framework for the Post-Employment Economy](https://medium.com/@djarid997/why-i-joined-the-green-party-2026-1a2b3c4d5e6f).*
