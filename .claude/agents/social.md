---
name: social
description: Sandboxed social network agent. Posts, reads notifications, checks metrics on Bluesky, Mastodon and Reddit. Use for ALL social media tasks. Runs via a containerised MCP server with no filesystem access.
