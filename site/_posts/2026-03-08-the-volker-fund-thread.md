---
layout: post
title: "The Volker Fund Thread"
date: 2026-03-08
description: "How a Kansas City charity fund, a small group of academics and a 25-year plan rewired the economic operating system of the Western world."
image: /assets/images/volker-fund-thread.png
tags: [economics, history, accessible]
---
...
- **IEA** (1955): Founded by Antony Fisher, at Hayek's direct encouragement
- **Heritage Foundation** (1973): Staffed Reagan's transition; 22 of his 76 economic advisers were Mont Pelerin members
- **Adam Smith Institute** (1977): The Thatcher-era policy pipeline
- **Cato Institute** (1977): Co-founded by Ed Crane, Mont Pelerin member
- **Atlas Network** (1981): Fisher again, coordinating the global replication of the model
...
The full analysis (with sourced evidence, probability assessments and adversarial testing) is [here]({{ site.baseurl }}/docs/global_transition.html). The shorter version covering the dollar system specifically is [here]({{ site.baseurl }}{% post_url 2026-03-04-the-dollars-expiry-date %}).

---

*Jason Huxley is an infrastructure and automation engineer (ex-Royal Corps of Signals) with 30 years' experience in large-scale enterprise systems. He is a member of the Green Party of England and Wales. His previous posts: [The Dollar's Expiry Date]({{ site.baseurl }}{% post_url 2026-03-04-the-dollars-expiry-date %}), [The Plumbing of Post-Employment Tax]({{ site.baseurl }}{% post_url 2026-03-07-the-plumbing-of-post-employment-tax %}) and [Why Brookings Gets AI Taxation Wrong]({{ site.baseurl }}{% post_url 2026-03-05-brookings-gets-ai-tax-wrong %}).*
