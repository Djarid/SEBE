...
The trend line said: within ten to fifteen years, automation would be displacing workers faster than the economy could create new roles for them. That meant income tax receipts would start declining. National Insurance receipts would follow. The government raises £420 billion a year from taxing workers' wages. That funding model has a shelf life, and the expiry date is visible from where I am standing.
...
I published the technical case for SEBE in my previous post, [Tax Robots, Fund People]({{ site.baseurl }}/blog/2026/02/25/tax-robots-fund-people/). This post is the personal one. I built this because nobody else was building it and because the window is closing.
